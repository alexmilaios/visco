 ...
 * string.
 */
public class OurText extends BinaryComparable
    implements WritableComparable<BinaryComparable> {
  private static final Log LOG= LogFactory.getLog(OurText.class);
   ...
   */
  public OurText(String string) {
    set(string);
  }

  /** Construct from another text. */
  public OurText(OurText utf8) {
    set(utf8);
  }

  /** Construct from a byte array.
   */
  public OurText(byte[] utf8)  {
    set(utf8);
  }
  ...
  /** copy a text. */
  public void set(OurText other) {
    set(other.getBytes(), 0, other.getLength());
  }

  /**
   * Set the OurText to range of bytes
  ...
  /*
   * Sets the capacity of this OurText object to <em>at least</em>
   ...
   * than the current capacity, the OurText object's capacity is
   * increased to match.
  ...
  /** Skips over one OurText in the input. */
  ...
  /** Returns true iff <code>o</code> is a OurText with the same contents.  */
  public boolean equals(Object o) {
    if (o instanceof OurText)
  ...
  /** A WritableComparator optimized for OurText keys. */
  ...
  static {
    ...
    WritableComparator.define(OurText.class, new Comparator());
  }
